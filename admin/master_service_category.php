...
<?php
  ...
  if(isset($_POST['sub']))
  {
    ...
    foreach($arrayData as $field) {
      if (empty($field)) {
        echo "<script>location.href='panel.php?page=master_service_category&e=b'</script>";die;
      }
    }
    if(checkExists($table, $arrayData) == 1){
      echo "<script>location.href='panel.php?page=master_service_category&e=e'</script>";die;
    }
    ...
    {
       echo "<script>location.href='panel.php?page=master_service_category&s=a'</script>";die;
    }
    else
    {
        echo "<script>location.href='panel.php?page=master_service_category&e=w'</script>";
    }
  }
  if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'delete')
  {
    ...
    if(isset($sno) && !empty($sno) && $sno != ''){
      ...
      {
        echo "<script>location.href='panel.php?page=master_service_category&s=d'</script>";die;
      }
      else
      {
        echo "<script>location.href='panel.php?page=master_service_category&e=w'</script>";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-4">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Service Category Master</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Service Category</h3>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="project-actions text-right">
                      <a class="btn btn-info btn-sm" href="panel.php?page=master_service_category&sno=<?php echo base64_encode($data['sno']);?>&action=edit">
                          <i class="fas fa-pencil-alt">
                          </i>
                          Edit
                      </a>
                      <a class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Delete This Row.')" href="panel.php?page=master_service_category&sno=<?php echo base64_encode($data['sno']);?>&action=delete">
            ...
            <div class="card card-primary">
				<div class="card-header">
					<h3 class="card-title">Add New <small>Category</small></h3>
				</div>
              <!-- /.card-header -->
              <!-- form start -->
            ...
            else if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit')
            {
              if(isset($_GET['sno']) && $_GET['sno']!='')
              {
                ...
                {
                  echo '<script>window.location.href="panel.php?page=master_service_category";</script>';die();
                }
              }
              else
              {
					...
					<div class="card-body">
						<div class="form-row">
							<div class="form-group col-md-4">
								...
								<input type="text" name="name" class="form-control" id="category" placeholder="Enter Category Name" value="<?php echo $name; ?>">
							</div>
